       ...
       01 INFO-SALDO.
           ...
           05 FILLER SIGN IS LEADING SEPARATE LINE 07 COL 38
               PIC -9(7) FROM SALDO-USER-ENT.
           05 FILLER LINE 07 COL 48 VALUE IS ".".
           05 FILLER LINE 07 COL 49 PIC 99 FROM SALDO-USER-DEC.
           05 FILLER LINE 07 COL 52 VALUE IS "EUR".
       ...
       01 SALDOPOSTERIOR.
           05 FILLER SIGN IS LEADING SEPARATE LINE 12 COL 46
               PIC -9(7) FROM SALDO-POST-ENT.
       ...
       PANTALLA-RECOGIDA.
           ...
           DISPLAY "." LINE 12 COLUMN 54.
           DISPLAY SALDO-POST-DEC LINE 12 COLUMN 55.
